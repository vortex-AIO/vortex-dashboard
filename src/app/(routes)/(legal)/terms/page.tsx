    ...
    return (
        <div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-kazu-main">
                    Copy vortex&apos;s website and claiming it as your own work
                </li>
            </div>
            <span className="font-bold text-2xl text-white pt-10">Vortex Bot Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-kazu-main">
                    Copy vortex&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-kazu-main">
                    Assist anyone in copying vortex&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-kazu-main">
                    Abuse or exploit vortex or any of our services.
                </li>
                <li className="text-neutral-400 marker:text-kazu-main">
