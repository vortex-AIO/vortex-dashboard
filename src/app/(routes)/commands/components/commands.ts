...
const commands: CommandsResponse[] = [
    {
        ...
        commands: [
                ...
                },
                {
                  ...
                  description: `Blacklist a command with optional scope.  Scopes: - \`in <channel_id>\`: Blacklist in a specific channel - \`for <user_id>\`: Blacklist for a specific user - \`in_guild <guild_id>\`: Blacklist in a specific guild`,
                  aliases: [],
                ...
                {
                  name: "lore add",
                  description: `Adds a message to the lorebook of the user who sent the referenced message. Must be used by replying to a message.`,
                  aliases: [],
                  usage: ";;lore add",
                  enabled: true,
                  cog: "Lore",
                ...
                },
                {
                  ...
                  description: `Delete one of your reminders by its ID.`,
                  aliases: [
                  "remove",
                  "cancel"
                ],
                  usage: ";;reminder delete <reminder_id>",
                  enabled: true,
                  cog: "Utility",
                  permissions: "None",
                  hidden: false
                ...
                {
                  name: "reminder timestamp",
                  description: `Get information about a Unix Timestamp.`,
                  aliases: [],
                  usage: ";;reminder timestamp [timestamp]",
                  enabled: true,
                  cog: "Utility",
                  permissions: "None",
                  hidden: false
                ...
                {
                  name: "translate",
                  description: `Translates the given text or a replied-to message into the default language.  Usage: ,translate <text> OR Reply to a message with ,translate`,
                  aliases: [
                  "trans",
                  "wtf"
                ],
                ...
                },
                {
                  ...
                  description: `Remove a command from blacklist.  Scopes: - \`in <channel_id>\`: Whitelist in a specific channel - \`for <user_id>\`: Whitelist for a specific user - \`in_guild <guild_id>\`: Whitelist in a specific guild`,
                  aliases: [],
