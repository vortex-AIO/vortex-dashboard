        ...
        body: [
            {
                ...
                commands: [
                    ...
                    },
                    {
                        ...
                        aliases: ["uafk", "unafk", "forceremove"],
                        usage: ";afk remove <member>",
                        enabled: true,
                        cog: "Utility",
                        permissions: "None",
                        hidden: false
                    ...
                    },
                    {
                        ...
                        description: `No description`,
                        aliases: [],
                        usage: ";antilink enable <url_type> <action> [channel] [time]",
                        enabled: true,
                        cog: "Automod",
                        permissions: "None",
                        hidden: false
                    ...
                    },
                    {
                        ...
                        description: `Remove specific URL types from the antilink rule.`,
                        aliases: [],
                        usage: ";antilink remove <url_type>",
                        enabled: true,
                        cog: "Automod",
                        permissions: "None",
                        hidden: false
                    },
                    {
                        ...
                        description: `No description`,
                        aliases: [],
                        usage: ";antilink alert [enabled] [channel]",
                        enabled: true,
                        cog: "Automod",
                        permissions: "None",
                        hidden: false
                    ...
                    {
                        name: "catfact",
                        description: `Get information about a cat breed`,
                        aliases: [],
                        usage: ";catfact [breed]",
                        enabled: true,
                        cog: "Fun",
                    ...
                    {
                        name: "hide",
                        description: `Hides the specified channel or the current channel if none is specified.  This prevents @everyone from viewing the channel.`,
                        aliases: [],
                        usage: ";hide [channel]",
                        enabled: true,
                        cog: "Moderation",
                    ...
                    },
                    {
                        ...
                        aliases: ["fyp", "doomscroll"],
                        usage: ";instagram trending",
                        enabled: true,
                        cog: "Reposters",
                        permissions: "None",
                        hidden: false
                    ...
                    {
                        name: "lock",
                        description: `Locks down the specified channel or the current channel if none is specified.  This prevents @everyone from sending messages in the channel.`,
                        aliases: [],
                        usage: ";lock [channel]",
                        enabled: true,
                        cog: "Moderation",
                    ...
                    {
                        name: "math calc",
                        description: `Calculate a mathematical expression with basic operations (+, -, *, /, ^, **)`,
                        aliases: [],
                        usage: ";math calc <expression>",
                        enabled: true,
                        cog: "Math",
                        permissions: "None",
                        hidden: false
                    ...
                    {
                        name: "math algebra",
                        description: `Solve equations or evaluate mathematical expressions`,
                        aliases: [],
                        usage: ";math algebra <input> [variable=x]",
                        enabled: true,
                        cog: "Math",
                        permissions: "None",
                        hidden: false
                    ...
                    {
                        name: "mutual",
                        description: `View mutual servers with the bot.  If no user is specified, shows your mutual servers with the bot.`,
                        aliases: ["mutuals", "mutualguilds", "mutualservers", "ms"],
                        usage: ";mutual [user]",
                        enabled: true,
                        cog: "Owner",
                        permissions: "None",
                    ...
                    },
                    {
                        ...
                        description: `Reset your hard R count and apologize.`,
                        aliases: [],
                        usage: ";nword apologize",
                        enabled: true,
                        cog: "Fun",
                        permissions: "None",
                        hidden: false
                    ...
                    },
                    {
                        ...
                        description: `Show the top 10 users with the most self-reactions, optionally filtered by emoji.`,
                        aliases: ["lb"],
                        usage: ";selfreaction leaderboard [emoji]",
                        enabled: true,
                        cog: "Fun",
                        permissions: "None",
                        hidden: false
                    },
                    {
                        ...
                        description: `No description`,
                        aliases: [],
                        usage: ";selfreaction reset [user] [table=False]",
                        enabled: true,
                        cog: "Fun",
                        permissions: "None",
                        hidden: false
                    ...
                    },
                    {
                        ...
                        aliases: ["enable"],
                        usage: ";slowmode on [channel] [time]",
                        enabled: true,
                        cog: "Moderation",
                        permissions: "None",
                        hidden: false
                    ...
                    },
                    {
                        ...
                        aliases: ["add", "new"],
                        usage: ";sticky create <note> [channel] [rate=5]",
                        enabled: true,
                        cog: "Utility",
                        permissions: "None",
                        hidden: false
                    ...
                    {
                        name: "unhide",
                        description: `Unhides the specified channel or the current channel if none is specified.  This allows @everyone to view the channel.`,
                        aliases: [],
                    ...
                    {
                        name: "unlock",
                        description: `Unlocks the specified channel or the current channel if none is specified.  This allows @everyone to send messages in the channel.`,
                        aliases: [],
                    ...
                    {
                        name: "uptime",
                        description: `Displays the bot's uptime and system information.`,
                        aliases: [],
                        usage: ";uptime",
                        enabled: true,
                        cog: "Information",
                    ...
                    {
                        name: "uwulock reset",
                        description: `Reset the uwulock table.`,
                        aliases: [],
                        usage: ";uwulock reset",
                        enabled: true,
                        cog: "Fun",
                    ...
                    {
                        name: "water remove",
                        description: `Remove the water reminder for this server.`,
                        aliases: [],
                        usage: ";water remove",
                        enabled: true,
                        cog: "Fun",
                    ...
                    {
                        name: "water add",
                        description: `Add a water reminder with the specified interval in minutes.`,
                        aliases: [],
                        usage: ";water add <channel> <delay>",
                        enabled: true,
                        cog: "Fun",
                        permissions: "None",
                        hidden: false
